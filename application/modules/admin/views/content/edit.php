                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <input type="hidden" name="id" value="<?=(isset($content['id'])) ? $content['id'] : "" ?>" class="form-control cid">
                                                <input type="text" class="form-control ctitle" maxlength="50" name="title" value="<?=(isset($content['title'])) ? $content['title'] : ""?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <textarea name="textarea" id="txt_cke" class="cdescription" rows="10"><?=(isset($content['description'])) ? $content['description'] : ""?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <select class="selectpicker cstatus">
                                                    ...
                                                    <option value="2" <?=($content['status'] == "2") ? "selected" : ""?>>Inactive</option>
                                                        </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                <div class="button-wrap">
                                    <button type="submit" class="commn-btn save content">Update</button>
                                </div>
                            </div>
                        </div>
