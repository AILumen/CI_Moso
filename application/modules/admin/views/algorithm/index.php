            ...
            <div class="inner-right-panel">
                ...
                <div class="form-item-wrap algo_tab_panel">
                    <div class="form-item-title clearfix open">
                        ...
                        <a href="javascript:void(0);" class="acctabaction">
                                ...
                                <div class="user-detail-panel algo_panel">
                                    <div class="col-lg-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <input type="text" readonly="true" name="" value="" placeholder="6">
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <input type="text" readonly="true" name="" value="" placeholder="3">
                                                <span class="input_unit">Miles</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <input type="text" readonly="true" name="" value="" placeholder="60">
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <input type="text" readonly="true" name="" value="" placeholder="30">
                                                <span class="input_unit">%</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-holder">
                                                <input type="text" readonly="true" name="" value="" placeholder="4">
                                                <span class="input_unit">Miles</span>
                                            </div>
                                        </div>
                                    </div>
