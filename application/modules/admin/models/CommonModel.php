...
class CommonModel extends CI_Model {
     ...
     */
    public function validateCookie($cookieName, $tableName, $sessionFields, $dataFields, $hashingField = "created_on") {
    ...
    public function getDataFromCookie($cookie, $tableName, $fields) {
        ...
        $hashedCookieValidator = hash("sha256", $loginCookie[1] . $cookieData["created_on"]);
